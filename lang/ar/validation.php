...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'content.subtitle' => 'الوصف',
        'content.primaryButton.text' => 'نص الزر الأول',
        'content.primaryButton.link' => 'رابط الزر الأول',
        'content.secondaryButton.text' => 'نص الزر الثاني',
        'content.secondaryButton.link' => 'رابط الزر الثاني',
        'content.image' => 'الصورة',
        'content.terms.term1' => 'العبارة الأولى (أسفل يسار)',
        'content.terms.term2' => 'العبارة الثانية (أعلى يمين)',
        'content.description' => 'الوصف',
        'content.cards' => 'القيم التالية',
        'content.cards.*.title' => 'العنوان',
        'content.cards.*.description' => 'الوصف',
        'content.milestones' => 'القيم التالية',
        'content.milestones.*.year' => 'السنة',
        'content.milestones.*.title' => 'العنوان',
        'content.milestones.*.description' => 'الوصف',
        'content.team' => 'القيم التالية',
        'content.team.*.name' => 'الاسم',
